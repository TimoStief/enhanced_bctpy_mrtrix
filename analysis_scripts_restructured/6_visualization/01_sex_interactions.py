...
SLOPES_CSV = Path('/data/local/129_PK01/derivatives/bct/time_effect_slopes.csv')
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / 'group1_sex_interaction_strength.png', dpi=300, bbox_inches='tight')
print("✅ Saved: group1_sex_interaction_strength.png")
plt.close()
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / 'all_groups_metrics_by_sex.png', dpi=300, bbox_inches='tight')
print("✅ Saved: all_groups_metrics_by_sex.png")
plt.close()
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / 'heatmap_sex_group_slopes.png', dpi=300, bbox_inches='tight')
print("✅ Saved: heatmap_sex_group_slopes.png")
plt.close()
...
# Save to CSV
df_summary.to_csv(OUTPUT_DIR / 'sex_group_statistics.csv', index=False)
print("✅ Saved: sex_group_statistics.csv")
